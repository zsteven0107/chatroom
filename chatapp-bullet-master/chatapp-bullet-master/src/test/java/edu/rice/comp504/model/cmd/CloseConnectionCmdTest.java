...
public class CloseConnectionCmdTest {
    ...
    @Test
    public void NotLastNonAdminCloseConnectionCmdTest(){
        chatRoom.addUser(user1.getUserID());
        user1.addChatRoom(chatRoom);
        CloseConnectionRequest closeConnectionRequest = RequestBuilder.buildCloseConnectionRequest(user1.getUserID());
        RequestDispatcher.handle(admin.getSession(), GsonInstance.getGson().toJson(closeConnectionRequest));
    ...
    @Test
    public void NotLastAdminCloseConnectionCmdTest(){
        chatRoom.addUser(user1.getUserID());
        user1.addChatRoom(chatRoom);
        UserManager.getOnly().getUserID(admin.getSession());
        CloseConnectionRequest closeConnectionRequest = RequestBuilder.buildCloseConnectionRequest(admin.getUserID());
        RequestDispatcher.handle(admin.getSession(), GsonInstance.getGson().toJson(closeConnectionRequest));
    ...
    @Test
    public void LastAdminCloseConnectionCmdTest(){
        CloseConnectionRequest closeConnectionRequest = RequestBuilder.buildCloseConnectionRequest(admin.getUserID());
        RequestDispatcher.handle(admin.getSession(), GsonInstance.getGson().toJson(closeConnectionRequest));
